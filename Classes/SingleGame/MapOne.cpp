...
bool MapOne::init()
{
	...
	int y1=map1.at("y").asInt();
	 ...
	 _player1=Sprite::create("enter.png");
	...
	int y2=map2.at("y").asInt();
	 _player2=Sprite::create("enter.png");
	...
	_player3=Sprite::create("enter.png");
    ...
    _player4=Sprite::create("enter.png");
	_player4->setPosition(x4,y4);
	_tileMap->addChild(_player4,1);

	ValueMap map5 = object->getObject("home");
	int x5 = map5.at("x").asInt();
	int y5 = map5.at("y").asInt();
	_player5 = Sprite::create("out.png");
	_player5->setPosition(x5, y5);
	_tileMap->addChild(_player5, 1);
...
void  MapOne::update(float f)
{
	...
	auto rectF = _player5->getBoundingBox();
